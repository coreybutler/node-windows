...
var daemon = function(config){
  ...
  Object.defineProperties(this,{
    ...
    _xml: {
      ...
      get: function(){
        var wrapperArgs = [
          ...
          '--fileArgs', JSON.stringify(this.args).replace(/"/g, '\\""')
        ];
    ...
    /**
    * @cfg {Array<String>} args
    * Arguments to append to the script launched.
    */
    args: {
      enumerable: true,
      writable: true,
      configurable: false,
      value: config.args instanceof Array ? config.args : []
    },
