...
var daemon = function(config){
  ...
  Object.defineProperties(this,{
    ...
    /**
     * @cfg {String} installDir
     * The absolute path where the daemonDir will be installed.
     * If omitted, path.dirname(config.script) is used.
     */
    installDir: {
      enumerable: true,
      writable: false,
      configurable: false,
      value: config.installDir !== undefined ? path.resolve(config.installDir) : path.dirname(config.script)
    },
    ...
    directory: {
      ...
      value: function(){
        ...
        return path.resolve(path.join(this.installDir, daemonDir));
      }
    },
